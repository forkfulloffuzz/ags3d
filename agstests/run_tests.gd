...
const ASYNC_SUITES: Array[String] = [
	...
	"m_cut/test_save_blocking.gd",             # T-CUT25
	"m_cut/test_cutscene_save_state.gd",       # T-CUT26
	"m_cut/test_dialogue_ducking.gd",          # T-CUT32
	...
	"m_cut/test_skip_state_consistency.gd",     # T-CUT24
