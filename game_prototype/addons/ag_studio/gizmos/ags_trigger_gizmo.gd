...
## Gizmo plugin for AGSTriggerRegion.
## Draws a purple wireframe box with full 6-face resize handles.

func _init() -> void:
	_color   = Color(0.7, 0.2, 1.0, 1.0)
	_xz_only = false
...
func _get_gizmo_name() -> String:
	return "AGSTriggerRegion"


func _has_gizmo(node: Node3D) -> bool:
	return node.get_class() == "AGSTriggerRegion"
