...
- [ ] **#84 T-E01** — Go: `.agroom` parser → `RoomData` struct
- [ ] **#85 T-E02** — Go: `RoomData` → Godot `.tscn` serialiser
- [ ] **#83 T-E03** — Go: `.agchar` parser + `CharData` → `.tscn`
- [ ] **#86 T-E04** — Go: wire scene generation into `ag build` pipeline
